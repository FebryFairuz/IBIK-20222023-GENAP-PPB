    ...
    <SafeAreaView>
      ...
      <View style={styles.container}>
        ...
        <View style={{ marginTop: 30 }}>
          <Button title="Hide Status Bar" onPress={()=>setToggleStatusBar(true)} />

          <TouchableOpacity activeOpacity={0.6}  onPress={()=>setToggleStatusBar(false)} >
